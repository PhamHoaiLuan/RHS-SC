...
contract RemoteHealthcareSystem {
    ...
    function Get_Patient(address _address) view public returns (address, uint, string, uint8, string) {
    ...
    function Get_Doctor(address _address) view public returns (address, uint, string, uint8, string) {
